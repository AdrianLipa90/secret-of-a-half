...
from secret_of_a_half.dhse_001_stage_i import run_stage_i


ROOT = Path(__file__).resolve().parents[1]
OUTPUT = ROOT / "data" / "processed" / "dhse_001_stage_i_receipt.json"
...
def main() -> None:
    ...
    if rendered != persisted:
        raise SystemExit("Stage I receipt mismatch")
