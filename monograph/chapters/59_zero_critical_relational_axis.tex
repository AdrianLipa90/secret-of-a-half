...
\path{SecretOfAHalfFormal/RadialDefect.lean} as
\path{riemannHypothesis_of_coercive_zero_energy}.
...
The formal layer now also contains the pointwise version
\path{riemannHypothesis_of_pointwise_coercive_zero_energy},
