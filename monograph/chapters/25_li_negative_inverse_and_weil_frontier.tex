...
\status{SOH-L012--SOH-L032 are retained as exact promoted reductions and no-go statements under their stated assumptions. SOH-C005 remains OPEN in the Weil/Li branch. SOH-G003 remains OPEN in the quotient branch. Historical route state at this stage: the Riemann Hypothesis was OPEN; this status is superseded by the proof architecture of Chapters~58--59.}
