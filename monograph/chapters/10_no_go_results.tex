...
\]
This non-negative function vanishes exactly at critical-line zeros, but its definition already combines the zero condition and the target line. It is therefore retained as a circular diagnostic rather than as the mechanism used by the current proof. The non-circular proof mechanism is given in Chapters~58--59.
