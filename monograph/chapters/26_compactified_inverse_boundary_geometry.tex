...
\begin{warning}
This chapter is an exact reduction, not by itself the final proof; the current Version 1.1 proof is given in Chapters~58--59. SOH-G003 remains open until a non-circular analytic argument proves real-rootedness of the quotient entire function $F$.
\end{warning}
