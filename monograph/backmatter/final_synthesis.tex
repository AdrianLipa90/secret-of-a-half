...
The exact projective orbit formulation, quotient real-rootedness criterion, external Fourier criterion, and classical Weil/Li criteria meet at an RH-equivalent boundary. Equivalence among them does not supply an external proof. In the minimum Occam channel the energy/coercivity edge is now derived; external closure therefore reduces to an independent non-circular derivation of the relational-zero realization principle R0 (or an equivalent theorem from standard analytic structure).
