...
\]
Thus entropy supplies a candidate Lyapunov or balance functional only after a zero-to-state relation is established.
...
The no-go results impose design requirements:
\begin{enumerate}
...
\end{enumerate}
These requirements guide the candidate routes in the next chapter.

\status{The counterexamples and obstructions are exact at the level stated. They rule out specific shortcuts, not every possible information-theoretic realization.}
