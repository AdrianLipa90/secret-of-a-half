...
from secret_of_a_half.dhse_001_stage_j import run_stage_j


ROOT = Path(__file__).resolve().parents[1]
OUTPUT = ROOT / "data" / "processed" / "dhse_001_stage_j_receipt.json"
...
def main() -> None:
    ...
    if rendered != persisted:
        raise SystemExit("Stage J receipt mismatch")
