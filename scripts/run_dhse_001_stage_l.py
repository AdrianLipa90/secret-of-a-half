...
from secret_of_a_half.dhse_001_stage_l import run_stage_l


ROOT = Path(__file__).resolve().parents[1]
OUTPUT = ROOT / "data" / "processed" / "dhse_001_stage_l_receipt.json"
...
def main() -> None:
    ...
    if rendered != persisted:
        raise SystemExit("Stage L receipt mismatch")
