...
\begin{warning}
The spinorial sign alone does not derive the phase law $\phi=2\pi\Re s$. In this chapter that law is a model identification. The current proof no longer depends on deriving this identification: Chapters~58--59 close the zero axis through A0, Shannon/KL coercivity, and the exact reciprocal--conjugation defect.
\end{warning}
