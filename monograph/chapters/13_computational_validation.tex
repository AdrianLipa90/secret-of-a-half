...
\input{generated/functional_equation_residuals_table.tex}
...
\begin{figure}[htbp]
 ...
 \caption{A scaled numerical plot of $\XiR(t)$ on the critical line. The finite plot is illustrative evidence only; the global proof is analytic and is given in Chapters~58--59.}
 \label{fig:xi-line}
\end{figure}
