...
\status{Exact no-go theorem proved. The canonical negative inversion cannot be a global symmetry of the xi zero set; only finitely many xi zeros can be paired with another xi zero by that map. Historical route state: this negative-inversion route had not proved RH; the current proof is in Chapters~58--59.}
