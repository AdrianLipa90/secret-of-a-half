...
It follows that the remaining target is sharper than SOH-G001:
...
\gap{The projective geometry, the inversion quotient, and exclusion of the positive real half-axis are closed. The only remaining analytic statement is quotient real-rootedness.}
