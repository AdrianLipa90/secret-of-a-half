...
\[
 ...
 1\le N\le20.
\]
The executor evaluates the sharp prime-tail incomplete-gamma certificate at
each scheduled cutoff, while independently recording the coarse asymptotic
envelope.
...
\begin{description}
\item[SOH-AC001, exact.] For every fixed $c>0$, the exponential adaptive
...
$N\le20$, the sharp certificates all pass $10^{-12}$ and have maximum
$3.280365246530569\times10^{-14}$ at $N=5$.
\end{description}

Pre-v0.9 snapshots used SOH-L021 for the exact asymptotic theorem. The canonical
v0.9 identifier is SOH-AC001; SOH-L021 now belongs exclusively to the local Li
growth theorem of \cref{chap:li-negative-inverse}.
