...
\emph{The Zero Axis} presents a proof of the Riemann Hypothesis from one universal relational-zero axiom. It begins from a single structural question: if zero is not an
...
\Re\rho=\frac12.
\]
Since \(\rho\) was arbitrary, the proof is complete:
\[
\boxed{\mathrm{A0}\Longrightarrow\mathrm{RH}.}
\]
This is the central proof claim of the monograph.
